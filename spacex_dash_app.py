...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        df_site_filtered=spacex_df[spacex_df['Launch Site']==entered_site]
        df1=df_site_filtered.groupby(['Launch Site','class']).size().reset_index(name='class count')
        fig=px.pie(df1,values='class count',names='class',title='Successful Launches from ' + entered_site)
        return fig
# TASK 4:
